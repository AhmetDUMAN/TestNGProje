...
public class JSAlertTestT {
    ...
    public void jsAlertTest(){
        ...
        button.click();
        String alertMesajı = driver.switchTo().alert().getText();
        System.out.println(alertMesajı);
        // alert'in içerisindeki "okay" butonuna tıklam için kullanılır.
    ...
    public void jsConfirmTest() {
        ...
        System.out.println(mesaj);
         // alert'in içerisindeki "Calcel" butonuna tıklar.
