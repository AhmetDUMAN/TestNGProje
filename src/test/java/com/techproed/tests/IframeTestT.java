...
public class IframeTestT {
    ...
    public void iframeTest2(){
        driver.get("https://the-internet.herokuapp.com/iframe");
        //id attributeu ilede iframe geçiş yapabiliyoruz
        driver.switchTo().frame("mce_0_ifr");
        WebElement paragraf1 = driver.findElement(By.xpath("//p"));
        paragraf1.clear();
        paragraf1.sendKeys("Merhaba Iframe");
    ...
    @Test
    public void iframeDışınaÇıkmak (){
        driver.get("https://the-internet.herokuapp.com/iframe");
        WebElement iframe = driver.findElement(By.id("mce_0_ifr"));
        driver.switchTo().frame(iframe);
